...
@implementation MessageDataControl
...
-(void)messageListData:(NSDictionary *)dicpush andshowView:(UIView *)view Callback:(completItemback)back
{
    ...
    [httpm getRequetInterfaceData:dicpush withInterfaceName:@"frontend.message/message" andresponseHandler:^(NSURLSessionDataTask *opration, id responceObjct, NSError *error) {
       if(view)
       {
