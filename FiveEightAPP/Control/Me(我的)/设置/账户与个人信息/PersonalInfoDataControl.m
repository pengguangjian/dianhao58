...
@implementation PersonalInfoDataControl
...
-(void)changeUserInfoData:(NSDictionary *)dicpush andshowView:(UIView *)view Callback:(completItemback)back
{
    ...
    [httpm postRequetInterfaceData:dicpush withInterfaceName:@"frontend.user/profile" andresponseHandler:^(NSURLSessionDataTask *opration, id responceObjct, NSError *error) {
       if(view)
       {
