...
- (void)viewDidLoad {
    ...
    [self setNavigationBarTitle:NSLocalizedString(@"mycollect", nil) leftImage:[UIImage imageNamed:@"ic_stat_back_n"] andRightImage:nil];
...
- (void)getdata {
    ...
    [datacontrol publishCollectData:dicpush andshowView:self.view Callback:^(NSError *eroor, BOOL state, NSString *desc) {
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete)
    {
        ...
        NSMutableDictionary *dicpush = [NSMutableDictionary new];
        [dicpush setObject:[User sharedUser].token forKey:@"token"];
        [dicpush setObject:model.did forKey:@"articleid"];
