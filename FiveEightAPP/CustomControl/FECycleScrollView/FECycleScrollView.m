...
#import "FECycleScrollViewFlowLayout.h"

@interface FECycleScrollView () <UICollectionViewDelegate, UICollectionViewDataSource>

@property (nonatomic, strong) FECycleScrollViewFlowLayout *flowLayout;
...
@implementation FECycleScrollView
...
- (void)initialization {
    ...
    _flowLayout = [[FECycleScrollViewFlowLayout alloc] init];
...
- (UICollectionViewScrollPosition)scrollPosition {
    switch (_scrollDirection) {
        case FEScrollDirectionVertical:
...
- (void)setScrollDirection:(FEScrollDirection)scrollDirection {
