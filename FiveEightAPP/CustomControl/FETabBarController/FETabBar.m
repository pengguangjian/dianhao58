...
#define FETabBarItemHeight    49.0f
...
- (void)layoutSubviews {
    ...
    switch (self.position) {
        case FETabBarCenterButtonPositionCenter:
            _centerBtn.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width - _centerWidth)/2.0, (FETabBarItemHeight - _centerHeight)/2.0 + self.centerOffsetY, _centerWidth, _centerHeight);
            break;
        case FETabBarCenterButtonPositionBulge:
