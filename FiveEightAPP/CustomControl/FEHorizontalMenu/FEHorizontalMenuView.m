...
#import "FEHorizontalMenuCollectionLayout.h"

#define kHorizontalMenuViewInitialPageControlDotSize CGSizeMake(6, 6)

@interface FEHorizontalMenuViewCell:UICollectionViewCell
...
@implementation FEHorizontalMenuViewCell
...
static NSString *FEHorizontalMenuViewCellID = @"FEHorizontalMenuViewCell";
@interface FEHorizontalMenuView ()<UICollectionViewDelegate,UICollectionViewDataSource,FEHorizontalMenuViewDelegate>

@property (nonatomic,strong) UICollectionView *collectionView;

@property (strong,nonatomic) UIControl         *pageControl;

@property (strong,nonatomic) FEHorizontalMenuCollectionLayout         *layout;

@end

@implementation FEHorizontalMenuView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _pageControlAliment = FEHorizontalMenuViewPageControlAlimentCenter;
        _pageControlBottomOffset = 5;
        _pageControlRightOffset = 0;
        _controlSpacing = 10;
        _pageControlStyle = FEHorizontalMenuViewPageControlStyleAnimated;
...
-(void)setUpPageControl
{
    ...
    switch (self.pageControlStyle) {
        case FEHorizontalMenuViewPageControlStyleAnimated:
        {
            ...
            break;
        case FEHorizontalMenuViewPageControlStyleClassic:
        {
    ...
    if (self.pageControlAliment == FEHorizontalMenuViewPageControlAlimentRight) {
...
-(UICollectionView *)collectionView{
    ...
    if (_collectionView == nil) {
        self.layout = [FEHorizontalMenuCollectionLayout new];
        ...
        [_collectionView registerClass:[FEHorizontalMenuViewCell class] forCellWithReuseIdentifier:FEHorizontalMenuViewCellID];
...
- (void)setDelegate:(id<FEHorizontalMenuViewDelegate>)delegate
{
    _delegate = delegate;
    ...
    if ([self.delegate respondsToSelector:@selector(customCollectionViewCellClassForHorizontalMenuView:)] && [self.delegate customCollectionViewCellClassForHorizontalMenuView:self]) {
        [self.collectionView registerClass:[self.delegate customCollectionViewCellClassForHorizontalMenuView:self] forCellWithReuseIdentifier:FEHorizontalMenuViewCellID];
        ...
        [self.collectionView registerNib:[self.delegate customCollectionViewCellNibForHorizontalMenuView:self] forCellWithReuseIdentifier:FEHorizontalMenuViewCellID];
    }
}
...
- (FEHorizontalMenuViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    FEHorizontalMenuViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:FEHorizontalMenuViewCellID forIndexPath:indexPath];
...
- (void)setCurrentPageDotImage:(UIImage *)currentPageDotImage
{
    ...
    if (self.pageControlStyle != FEHorizontalMenuViewPageControlStyleAnimated) {
        self.pageControlStyle = FEHorizontalMenuViewPageControlStyleAnimated;
    }
